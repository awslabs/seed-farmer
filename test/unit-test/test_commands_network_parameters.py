            ...
            "region_mappings": [
                {
                    ...
                    "parameters_regional": {
                        ...
                        "privateSubnetIds": [
                            "subnet-0c36d3d5808f67a02",
                            "subnet-00fa1e71cddcf57d3"
                        ],
                        "isolatedSubnetIds": [
                            "subnet-XXXXXXXXX",
                            "subnet-XXXXXXXXX"
...
def test_vpc_from_ssm(session_manager,mocker):    
    mocker.patch("seedfarmer.commands._network_parameter_commands.ssm.get_parameter", 
                 return_value="vpc-01e556d052f429282"
                 )
    deployment_manifest_json['target_account_mappings'][0]["region_mappings"][0]["network"] = {
             "vpc_id":{
                    "value_from": {
...
def test_too_many_subgroups(session_manager,mocker): 
    os.environ['testsgs']='["sg-049033188c114a3d2","sg-049033188c114a3d2","sg-049033188c114a3d2","sg-049033188c114a3d2","sg-049033188c114a3d2","sg-049033188c114a3d2"]'
