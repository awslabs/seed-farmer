            ...
            "modules": [
                {
                    ...
                    "parameters": [
                        ...
                        {
                            "value_from": {"module_metadata": {"name": "eks", "group": "core", "key": "EksOidcArn"}},
                            "name": "EksOidcArn",
                        },
                        {
                            "value_from": {
                    ...
                    "deploy_spec": {
                        ...
                        "destroy": {
                            "phases": {
                                "install": {
                                    "commands": ["npm install -g aws-cdk@2.20.0", "pip install -r requirements.txt"]
                                },
                                "pre_build": {"commands": []},
                                "build": {
                                    "commands": [
...
module_dependencies = {
    "optionals-networking": ["core-eks", "core-efs"],
    "core-eks": ["platform-kubeflow-platform", "platform-efs-on-eks"],
    "core-efs": ["platform-efs-on-eks"],
}
